...
class ObjectDetection:
    def __init__(self):
        ...
        # dataset downloaded from https://www.kaggle.com/datasets/davidbroberts/brain-tumor-object-detection-datasets/data?select=sagittal_t1wce_2_class
        self.dir="C:/BrainTumor_sagittal_t1wce_Yolov10"
    ...
    def train(self, runName):
        ...
        yaml_path = "sagittal_t1wce_2.yaml"
        results = model.train(
